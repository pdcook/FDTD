...
\usepackage{physics}
\usepackage{multicol}
\usepackage[textwidth=469.0pt,textheight=548.5pt]{geometry}
\hypersetup{
    colorlinks=true,
    urlcolor=blue,
    linkcolor=blue,
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{Before.eps}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\linewidth]{SmallObjectAfter.eps}
\caption{The pulse shortly after interacting with a small square object placed at the origin.}
\label{fig:SmallObjectAfter}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.98\linewidth]{SmallObjectLongAfter.eps}
