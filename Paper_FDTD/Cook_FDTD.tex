...
\tilde{E_x}(z_i,t_j) = \frac{\tilde{D}(z_i,t_j)-\frac{\sigma\Delta t}{\epsilon_0}\sum_{n=0}^{j-1}\tilde{E_x}(z_i,t_j)}{\epsilon_r+\frac{\sigma\Delta t}{\epsilon_0}}.
\end{equation}
...
\end{split} \\
\label{eq:1D_E}
&\tilde{E_x}(z_i,t_j) = \frac{\tilde{D}(z_i,t_j)-I(z_i,t_{j-1})}{\epsilon_r+\frac{\sigma\Delta t}{\epsilon_0}},\\
\label{eq:1D_I}
&I(z_i,t_j) = \frac{\sigma\Delta t}{\epsilon_0}\sum_{n=0}^{j}\tilde{E_x}(z_i,t_n), \\
